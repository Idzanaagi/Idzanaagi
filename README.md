...
В разработке привлекает многообразие задач и способов их решения. Нравится изучать новые вещи и применять их на практике. Поэтому, например, здесь появился [этот](https://github.com/Idzanaagi/Idzanaagi#qa) раздел.
